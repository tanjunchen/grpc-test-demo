...
import (
	...
	status "grpc-test-demo/src/status"
	reflect "reflect"
	sync "sync"
)
...
func (x *ProdResponse) GetStatus() *status.Status {
	if x != nil {
		return x.Status
	}
	return nil
...
var file_prod_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x04, 0x70, 0x72,
	0x6f, 0x64, 0x1a, 0x13, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2f, 0x73, 0x74, 0x61, 0x74, 0x75,
	...
	0x55, 0x0a, 0x0c, 0x50, 0x72, 0x6f, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	0x1d, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x64, 0x5f, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x01, 0x20,
	0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x72, 0x6f, 0x64, 0x53, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x26,
	...
	,
...
var file_prod_proto_depIdxs = []int32{
	2, // 0: prod.ProdResponse.status:type_name -> status.Status
	0, // 1: prod.ProductService.GetProductStock:input_type -> prod.ProdRequest
	1, // 2: prod.ProductService.GetProductStock:output_type -> prod.ProdResponse
...
func (c *productServiceClient) GetProductStock(ctx context.Context, in *ProdRequest, opts ...grpc.CallOption) (*ProdResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/prod.ProductService/GetProductStock", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedProductServiceServer) GetProductStock(context.Context, *ProdRequest) (*ProdResponse, error) {
	return nil, status1.Errorf(codes.Unimplemented, "method GetProductStock not implemented")
}
...
func _ProductService_GetProductStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/prod.ProductService/GetProductStock",
	}
